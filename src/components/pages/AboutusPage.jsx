            ...
            <section className="relative py-20 bg-white/50 dark:bg-gray-900/50 backdrop-blur-sm">
                <div className="container mx-auto px-4">
                    <div className="text-center mb-16">
                        <h2 className="text-4xl font-bold mb-4 bg-gradient-to-r from-gray-800 to-gray-900 dark:from-gray-100 dark:to-white bg-clip-text text-transparent">Powered by Intelligence</h2>
                        <p className="text-lg text-gray-600 dark:text-gray-400 max-w-2xl mx-auto">
                            Our platform uses advanced Machine Learning to ensure quality and accuracy in every listing.
                        </p>
                    </div>
                    ...
                    <div className="grid md:grid-cols-2 gap-12 max-w-5xl mx-auto">
                        ...
                        <div className="relative group">
                            <div className="absolute inset-0 bg-gradient-to-br from-blue-500/20 to-cyan-500/20 rounded-3xl blur-xl group-hover:blur-2xl transition-all opacity-70"></div>
                            <div className="relative bg-white dark:bg-gray-800 p-8 rounded-3xl border border-blue-100 dark:border-blue-900/30 shadow-xl">
                                ...
                                <h3 className="text-2xl font-bold mb-4 text-gray-900 dark:text-white">1. The Gatekeeper</h3>
                                <p className="text-gray-600 dark:text-gray-300 leading-relaxed">
                                    A specialized model first scans every upload to verify it is a genuine clothing item, filtering out irrelevant images to maintain platform integrity.
                                </p>
                            </div>
                        </div>
                        ...
                        {/* The Specialist */}
                        <div className="relative group">
                            <div className="absolute inset-0 bg-gradient-to-br from-purple-500/20 to-pink-500/20 rounded-3xl blur-xl group-hover:blur-2xl transition-all opacity-70"></div>
                            <div className="relative bg-white dark:bg-gray-800 p-8 rounded-3xl border border-purple-100 dark:border-purple-900/30 shadow-xl">
                                ...
                                <h3 className="text-2xl font-bold mb-4 text-gray-900 dark:text-white">2. The Specialist</h3>
                                <p className="text-gray-600 dark:text-gray-300 leading-relaxed">
                                    Once verified, a second high-precision model analyzes the style and texture to automatically classify the item into specific categories like T-Shirts, Trousers, or Dresses.
                                </p>
                            </div>
                        </div>
                    </div>
